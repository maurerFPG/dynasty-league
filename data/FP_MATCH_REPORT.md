# FantasyPros dynasty Superflex ECR match report

Source: `data/fp_dynasty_op_dk.json` (FantasyPros API snapshot).
Type Dynasty, position OP (Superflex), scoring PPR. Not the Draft Wizard cheat sheet.
Sleeper ids via the same conservative matcher as `tools/ingest_cheatsheet.py`.

- Snapshot present: **True**
- Snapshot rows: **547**
- Type / position / scoring: **Dynasty / OP / PPR**
- Experts: **26** · last updated **8/22** · tier **premium**
